      ...
      <table class="table table-striped b-t b-light">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              <a href="#" ui-toggle-class="" class="edit_image" id="<?php echo $row['id'] ?>">
                <i class="fa fa-pencil-square-o" ></i></a>
              <a  href="#" ui-toggle-class="" class="delete_image" id="<?php echo $row['id'] ?>" >
 ...
 <script type="text/javascript">
  $(document).ready(function() {
    $('.edit_image').click(function(){
      ...
      $.get( "edit_image.php",{ id: user_id },  function( data ) {
