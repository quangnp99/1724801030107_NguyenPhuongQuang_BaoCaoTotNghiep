    ...
    <ul class="nav pull-right top-menu">
        ...
        <li class="dropdown">
            ...
            <ul class="dropdown-menu extended logout">
                ...
                <li><a href="user_logout.php"></i> Đăng Xuất</a></li>
            </ul>
        </li>
            ...
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub" >
						...
						<li><a href="#" id="show" >Liệt kê người dùng</a></li>
                    </ul>
                </li>
                ...
                <li class="sub-menu" >
                    ...
                    <ul class="sub">
						<li><a href="#" id="all_image">Liệt kê hình ảnh </a></li>
						<li></li>
                    </ul>
                </li>
                ...
                <li class="sub-menu" >
                    <a href="javascript:;">
                        <i class="fa fa-book"></i>
                        <span>Quản lý lượt like</span>
                    </a>
                    <ul class="sub">
						<li><a href="#" id="all_like">Lịch sự lượt thích </a></li>
						<li></li>
                    </ul>
                </li>
...
<section id="main-content">
 ...
 <!-- footer -->
		  <div class="footer">
			<div class="wthree-copyright" id="show_image">
...
<script>
	$(document).ready(function() {
		...
		$('#show').click(function(){
		      $.get( "all_user.php", function( data ) {
		  $( "#show_image" ).html( data );
		});
 	});
		$('#all_image').click(function(){
		      $.get( "all_image.php", function( data ) {
		  $( "#show_image" ).html( data );
		});
   
	});

		$('#all_like').click(function(){
