...
if (isset($_GET["check_login"])) {
	if ($_GET["check_login"] == "false" ) {
		echo "<p style='color: red; background: yellow; text-align: center; '>Username hoac Password sai</p> ";
	}
}
...
<div class="w3layouts-main">
	<h2>Đăng nhập</h2>
		...
		<p>Don't Have an Account ?<a href="user_registration.php">Create an account</a></p>
</div>
</div>
