...
<div class='js-home-links-title title-tabs__title title'> <h3>Kho ảnh miễn phí</h3></div>
        ...
        switch ($flag) {
          case 1:
            ...
            <div class="d-block w-100 carousel slide">
              <a href="photo_details.php?id='.$row['id'].'"><img class="img_show" src="'.$row['url'].'" >
...
<div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
  <div class="row">
    <?php 
      $sql_ex = 'SELECT * FROM `si_image` WHERE status=1 ORDER BY view DESC LIMIT 4' ;
      
      $retval_ex= mysqli_query($conn, $sql_ex); 
       ...
       $col4='';
       $flag = 1;
    if(mysqli_num_rows($retval_ex) > 0){  
     while($row = mysqli_fetch_assoc($retval_ex)){ 
        switch ($flag) {
          case 1:
            $col1 = $col1.'
            <div class="d-block w-100 carousel slide">
              <a href="photo_details.php?id='.$row['id'].'"><img class="img_show" src="'.$row['url'].'" style="width:100%">
              <div class="carousel-caption d-none d-md-block">
              </div>
              <div class="d-flex flex-row-reverse">
                    <div class="p-2">
