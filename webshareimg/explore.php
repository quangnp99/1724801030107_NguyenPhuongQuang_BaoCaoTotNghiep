...
<div class='js-home-links-title title-tabs__title title'> <h3>Khám phá</h3></div>


<div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
  <div class="row">
    <?php 
      $sql_explore = 'SELECT * FROM `si_image`  WHERE status=1 ORDER BY RAND() LIMIT 20' ;
      
      $retval_explore= mysqli_query($conn, $sql_explore); 
       ...
       $col4='';
       $flag = 1;
    if(mysqli_num_rows($retval_explore) > 0){  
     while($row = mysqli_fetch_assoc($retval_explore)){ 
        switch ($flag) {
          case 1:
            $col1 = $col1.'
