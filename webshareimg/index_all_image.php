...
<div class='js-home-links-title title-tabs__title title'> <h3>Kho ảnh mới tải lên</h3></div>


<div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
  <div class="row">
    <?php 
      $sql_all_image = 'SELECT * FROM `si_image` WHERE status=1 ORDER BY id DESC' ;
      
      $retval= mysqli_query($conn, $sql_all_image); 
